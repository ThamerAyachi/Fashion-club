  ...
  <div>
      ...
      <div class="grid sm:grid-cols-3 grid-cols-1 lg:mx-32 mx-5 my-10">
        ...
        <div class="grid lg:grid-cols-3 col-span-2 grid-cols-2 mx-4 gap-3 my-10">
            <ProductCard 
            img="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQdG5-eCiBPGRoyt_-iI-GpwRfmbK5L13Zzxw&usqp=CAU"
             />
            <ProductCard 
            img="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRLEBcrfXyyXs12JY197vvRmN4Dhv_FilrVqA&usqp=CAU"
            isNew="true"
             />
            <ProductCard 
            img="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTVjxEdeEEFsRQQw_5knITp_NzJGTfhxzEc2Q&usqp=CAU"
             />
            <ProductCard 
            img="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS3QptVyA2mJerKack1HH9MsdyDN3lS5kTEjQ&usqp=CAU"
             />
            <ProductCard 
            img="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTY8WLZNkx-ovt9w51ehXADIOkm1sRACEIdPw&usqp=CAU"
             />
        </div>
      </div>
