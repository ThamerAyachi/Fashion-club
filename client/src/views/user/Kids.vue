  ...
  <div>
      ...
      <div class="grid sm:grid-cols-3 grid-cols-1 lg:mx-32 mx-5 my-10">
        ...
        <div class="grid lg:grid-cols-3 col-span-2 grid-cols-2 mx-4 gap-3 my-10">
            <ProductCard 
            img="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR1zySTKfC4RUGDKyZ9_Wh5stZC3D9XaThJKQ&usqp=CAU"
             />
            <ProductCard 
            img="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQbdbKrOPWqvBEmhysJGvXIo2tAHi_CuCuNwA&usqp=CAU"
            isNew="true"
             />
            <ProductCard 
            img="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRmbbStBOAY_cZN77rrWrHUTWTmkrDaIVAsjA&usqp=CAU"
             />
            <ProductCard 
            img="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQbdbKrOPWqvBEmhysJGvXIo2tAHi_CuCuNwA&usqp=CAU"
             />
