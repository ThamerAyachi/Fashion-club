  ...
  <div>
      ...
      <div class="banner min-h-52 grid grid-cols-1 md:grid-cols-2">
        <div class="md:my-40 md:mx-16 my-5 mx-5">
          <span class="uppercase block text-primary md:text-3xl text-xl md:my-5 my-2 font-medium tracking-widest">welcome to</span>
          <span class="uppercase block text-white md:text-5xl text-4xl font-semibold md:my-5 my-2">fashion <span class="text-primary">club</span></span>
          <span class="block text-gray-300 text-sm my-2 md:my-5 mr-14 tracking-wide leading-7 ">
            Fashion club is one of the best online shopping stores in Tunisia. We provide a large variety of international products across the globe. 
          </span>
          <router-link to="/about" class="my-5 text-white bg-black hover:bg-primary text-sm px-3 p-2 transition duration-300">
            <span>Read More</span>
          </router-link>
        </div>
        <div></div>
        ...
        <div class="grid md:grid-cols-2 grid-cols-1 space-y-2">
          ...
          class="sold-1 flex justify-center items-center hover:scale-110 duration-500 transform md:mx-5 lg:mx-20 text-white">
            <div class="my-28 md:my-44 w-full text-center">
              ...
              <span class="font-medium text-xl mr-3">upto <span class="ml-1 text-5xl">75%</span></span>
            </div>
          </router-link>
          <div class="grid md:grid-cols-2 grid-cols-1 gap-5">
            <router-link :to="doc.path"
              v-for="doc in solds" :key="doc.id"
            ...
            >
              <div class="my-28 md:my-20 w-full text-center">
                <span class="uppercase block text-5xl">sale</span>
                <span class="font-medium text-xl mr-3">upto <span class="ml-1 text-5xl">{{ doc.persent }}%</span></span>
              </div>
            </router-link>
          </div>
        </div>
      ...
      <div class="w-full">
        <div class="flex justify-center">
          <span class="block text-4xl my-5 font-medium tracking-wide"> New Launches </span>
        </div>
        ...
        <div class="flex justify-center">
          <span class="block text-4xl my-5 font-medium tracking-wide">Top Brands</span>
        </div>

        <!-- brands -->
        <div class="overflow-x-scroll mt-4 flex space-x-4 md:mx-32 mx-5 brands my-4">
          <div class="rounded my-2 w-64  mx-2 flex-none" v-for="brand, i in brands" :key="i">
