  ...
  <div>
      ...
      <div class="grid sm:grid-cols-3 grid-cols-1 lg:mx-32 mx-5 my-10">
        ...
        <div class="grid lg:grid-cols-3 col-span-2 grid-cols-2 mx-4 gap-3 my-10">
            <ProductCard 
            img="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRAIEB7ZKKY_RKzV2lJhBWnxgnDcnU6tV-gOg&usqp=CAU"
             />
            <ProductCard 
            img="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcREEJKOopDM3z3Nt6iDhYIV4uf1O6Be6oBmhw&usqp=CAU"
            isNew="true"
             />
            <ProductCard 
            img="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQFKfUF-DK76B7CqXbl8k67H0RMof2gMRAYMg&usqp=CAU"
            isNew="true"
             />
            <ProductCard 
            img="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRAIEB7ZKKY_RKzV2lJhBWnxgnDcnU6tV-gOg&usqp=CAU"
...
export default {
    data(){return{
        ...
        btnsCategories: [
            {text: 'Women Shoes', categorie: 'womenShoes'},
            {text: 'Men shoes', categorie: 'menShoes'},
            {text: 'Casual shoes', categorie: 'casualShoes'},
            {text: 'Running shoes', categorie: 'runningShoes'},
        ],
        btnsSize:[
            {text: 'Medium', size: 'm'},
            {text: 'Large', size: 'l'},
