  ...
  <div>
      ...
      <div class="grid sm:grid-cols-3 grid-cols-1 lg:mx-32 mx-5 my-10">
        ...
        <div class="grid lg:grid-cols-3 col-span-2 grid-cols-2 mx-4 gap-3 my-10">
            <ProductCard 
            img="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSfAAW9y5gJ-e04SAxiilL4998rUilgbjkAZQ&usqp=CAU"
             />
            <ProductCard 
            img="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTSgZ5liqIe9gtHX3u95G6JV3OGK5BBCcwL8Q&usqp=CAU"
            isNew="true"
             />
            <ProductCard 
            img="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSfAAW9y5gJ-e04SAxiilL4998rUilgbjkAZQ&usqp=CAU"
...
export default {
    data(){return{
        ...
        btnsCategories: [
            {text: 'Long skirts', categorie: 'lSkirts'},
            {text: 'Frocks', categorie: 'frocks'},
            {text: 'Maxi dress', categorie: 'mDress'},
        ],
        btnsSize:[
            {text: 'Medium', size: 'm'},
            {text: 'Large', size: 'l'},
