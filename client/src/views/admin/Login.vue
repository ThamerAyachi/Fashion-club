  ...
  <div class="flex items-center justify-center h-screen px-6 bg-green-50">
    <div class="w-full max-w-sm p-6 bg-white rounded-md shadow-md">
      ...
      <form class="mt-4" @submit.prevent="signUp">
        ...
        <div class="bg-red-100 rounded-lg py-3 mt-2 px-6 text-base text-red-700 mb-3" v-if="v$.$error">
        ...
        <div class="mt-6">
          <button
            type="submit"
            class="w-full px-4 py-2 text-sm text-center text-white bg-primary rounded-md focus:outline-none hover:bg-green-400"
          >
            Sign in
          </button>
        </div>
